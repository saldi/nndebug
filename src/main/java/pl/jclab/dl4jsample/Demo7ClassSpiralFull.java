...
public class Demo7ClassSpiralFull{
	...
	public static void main(String[] args){
		...
		int samples = 500;
		double noise = 0;
		double testTrainFactor = 0.6;

		DataUtil.setSeed(500);

		final DataSet dataSet = DataUtil.classifySpiral(samples, noise);
		...
		net.setListeners(NetListenerBuilder.Builder()
										   .name("Demo7 Class Full Spiral Network")
